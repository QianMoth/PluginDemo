 ...
 *
 */
class FLOW_EDITOR_PUBLIC PluginsManager : public QObject
{
    Q_OBJECT
...
private:
    ...
    std::shared_ptr<DataModelRegistry> _register = std::make_shared<DataModelRegistry>();
};
