...
#include <memory>
// #include "../../../../../../3rdparty/nodeeditor/include/nodes/internal/NodeDataModel.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len)                            \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
                                                            qptrdiff(offsetof(qt_meta_stringdata_QtNodes__NodeDataModel_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
...
void QtNodes::NodeDataModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        {
        case 0:
            _t->dataUpdated((*reinterpret_cast<PortIndex(*)>(_a[1])));
            break;
        case 1:
            _t->dataInvalidated((*reinterpret_cast<PortIndex(*)>(_a[1])));
            break;
        case 2:
            _t->computingStarted();
            break;
        case 3:
            _t->computingFinished();
            break;
        case 4:
            _t->embeddedWidgetSizeUpdated();
            break;
        case 5:
            _t->inputConnectionCreated((*reinterpret_cast<const Connection(*)>(_a[1])));
            break;
        case 6:
            _t->inputConnectionDeleted((*reinterpret_cast<const Connection(*)>(_a[1])));
            break;
        case 7:
            _t->outputConnectionCreated((*reinterpret_cast<const Connection(*)>(_a[1])));
            break;
        case 8:
            _t->outputConnectionDeleted((*reinterpret_cast<const Connection(*)>(_a[1])));
            break;
        default:;
        }
    }
...
QT_INIT_METAOBJECT const QMetaObject QtNodes::NodeDataModel::staticMetaObject = {{QMetaObject::SuperData::link<QObject::staticMetaObject>(),
